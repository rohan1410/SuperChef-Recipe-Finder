...
<input type="submit" name="submit" value="Search Recipe" style="background-color:#1a1a1a;color:white;font-size:17px;margin-left: 90px;border-radius:5px;border: 3px solid #262626;margin-top: 8px"/>
</form>
</div  >
...
while($row=mysql_fetch_array($res)){
    ...
    <?php
        echo "</a>";
        echo "<figcaption>";
        echo "<h4 style='color: white;text-shadow: black 0.15em 0.1em;background-color:rgba(140,140,140,0.7)'>";
        echo $row["name"];
        echo "</h4>";
        echo "<p>";
        echo '<a href="'.$row['site'].'">'."<span class='glyphicon glyphicon-cutlery'></span></a>";
        echo "</p>";
        echo "</figcaption>";
        echo "</figure>";
        echo "</a>";
...
<!--<div class="grid" >
                    ...
                    <figure class="effect-kira" >
                        ...
                        <figcaption>
                            ...
                            <p><iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&width=63&layout=button&action=like&size=large&show_faces=true&share=false&height=65&appId" width="63" height="65" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                                <a href="#"><i class="fa fa-fw fa-home"></i></a>
                                <a href="#"><i class="fa fa-fw fa-download"></i></a>
                                <a href="#"><i class="fa fa-fw fa-heart"></i></a>
                                <a href="#"><i class="fa fa-fw fa-share"></i></a>
